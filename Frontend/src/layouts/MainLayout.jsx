...
const routeMeta = {
  ...
  '/requests': { title: 'Requests', subtitle: 'Waitlist overview and renewals' },
  '/notifications': { title: 'Notifications', subtitle: 'Waitlist and renewal alerts' },
  '/user/books': { title: 'Books', subtitle: 'Browse catalog and join waitlists' },
  '/user/requests': { title: 'My Requests', subtitle: 'Waitlist and renewal status' },
  '/user/borrows': { title: 'My Borrows', subtitle: 'Active loans and renewals' },
